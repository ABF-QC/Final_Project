...
text=f"At first, this page will allow you to navigate through the history of \
       maximum temperature of downtown Montreal spanning more than a century.\
       </br></br> Maximum temperature are quite important, since they can have \
       a significant impact on someone health and safety. Temperature above 30 °C\
       lead to an increase risk of heat stroke and can have an sigificant health\
       impact on vulnerable communities. At the other end of the spectrum, maximum \
       temperature lower than -20 °C can lead to a frostbite on exposed skin very rapidly \
       and can be a significant health hazard for vulnerable communities.</br></br> \
       The second portion of the page will allow you to explore the yearly frequency \
       of some weather events regarding the maximum temperature and see their evolution\
       over the last century.</br></br> Finally, the last portion of the page will give\
       you an insight of what maximum temperature could look like over the next 50 years\
